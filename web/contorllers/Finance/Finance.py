...
from common.libs.Helper import ops_render, iPagination, selectFilterObj, getDictFilterField, getCurrentDate, \
    getDictListFilterField
...
def index():
    ...
    if pay_list:
        ...
        if pay_order_items_map:
            ...
            book_mapping = getDictFilterField(Book, Book.id, "id", book_ids)
...
def info():
    ...
    if order_item_list:
        book_map = getDictFilterField(Book, Book.id, "id", selectFilterObj(order_item_list, "book_id"))
