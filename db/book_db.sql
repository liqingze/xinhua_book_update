...
CREATE TABLE `app_access_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=2904 DEFAULT CHARSET=utf8mb4 COMMENT='用户访问记录表';
...
CREATE TABLE `app_error_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1613 DEFAULT CHARSET=utf8mb4 COMMENT='app错误日表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COMMENT='书籍分类';
...
CREATE TABLE `book_sale_change_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_book_id_id` (`book_id`)
) ENGINE=InnoDB AUTO_INCREMENT=309 DEFAULT CHARSET=utf8mb4 COMMENT='商品销售情况';
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COMMENT='数据库存变更表';
...
CREATE TABLE `member_comments` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_member_id` (`member_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='会员评论表';
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COMMENT='第三方登录绑定关系';
...
CREATE TABLE `pay_order` (
  ...
  KEY `idx_member_id_status` (`member_id`,`status`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COMMENT='在线购买订单表';
...
CREATE TABLE `pay_order_item` (
  ...
  `book_id` int(11) NOT NULL DEFAULT '0' COMMENT '图书表id',
  `note` text NOT NULL COMMENT '备注信息',
  ...
  KEY `idx_book_id` (`book_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='订单详情表';
...
) ENGINE=InnoDB AUTO_INCREMENT=306 DEFAULT CHARSET=utf8mb4 COMMENT='书籍售卖日统计';
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COMMENT='会员日统计';
...
CREATE TABLE `stat_daily_site` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_date` (`date`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8mb4 COMMENT='全站日统计';
