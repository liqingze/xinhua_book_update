...
class StatDailyBook(db.Model):
    __tablename__ = 'stat_daily_book'
    __table_args__ = (
        db.Index('date_book_id', 'date', 'book_id'),
    )

    id = db.Column(db.Integer, primary_key=True)
    date = db.Column(db.Date, nullable=False)
    book_id = db.Column(db.Integer, nullable=False, server_default=db.FetchedValue())
